...
import { createChannel, addMember, removeMember, listMessages, sendMessage, getChannel, ensureGeneralAndJoin, listChannels, mirrorMessage, reactToMessage, unreactToMessage, grantChannelModerator, revokeChannelModerator, listChannelModerators, deleteChannel, deleteChannelMessage, redactChannelMessage, markChannelAsRead, getUserUnreadSummary, getChannelUnreadCount } from '../controllers/channelController.js'
...
router.delete('/channels/:channelId/messages', validatePlatformToken, requireRole([ROLES.SUPER_ADMIN]), deleteChannelMessage)
router.post('/channels/:channelId/messages/redact', validatePlatformToken, redactChannelMessage)
